...
app.post('/generate-summary', async (req, res) => {
  ...
  const prompt = `Write a concise and engaging professional summary for a resume in 80 words. The candidate is applying for the position of ${jobTitle} and has 5 years of experience at Cognizant. Be sure to include the company name, Cognizant, and highlight the candidate’s strengths, professionalism, and motivation for this role.`;
  try {
